...
<b><i>Hi,Welcome to our  Blood Bank Management System Website.Save Lives</b></i>
</marquee>
    <section>
 <br>
  <div id="myCarousel" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        ...
        <img src="images/aman.jpg" alt="Chania" width="460" height="345">
        <p></p>
      </div>
   
      <div class="item">
        <img src="images/Blood-Donation-1.jpg" alt="Chania" width="460" height="345">
      </div>
    ...
    <div class="container">
        <div class="col-md-8 main-section">
            <h2>Our Mission</h2>
            <p>
                  Will provide a sustained and effective humanitarian service committed to build resilient communities, ran by well-trained and dedicated staff and volunteers imbued with integrity, equipped with the necessary logistics and the maximum usage of information technology.
            </p>
            <p class="note">
